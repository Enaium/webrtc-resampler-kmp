 ...
 * Ships libwebrtc_resampler_jni.dylib as a classpath resource at
 * /cn/enaium/webrtc/resampler/native/darwin-aarch64/, which NativeLoader
...
val libFile = "libwebrtc_resampler_jni.dylib"
...
val buildJniLibrary by tasks.registering(Exec::class) {
    group = "build"
    description = "Builds libwebrtc_resampler_jni.dylib for $classifier."
    onlyIf { canBuildHere }
